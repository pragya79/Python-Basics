...
Label(main, text="STUDENT MANAGEMENT SYSTEM", font=headlabelfont, bg='blue').pack(side=TOP, fill=X)
...
Label(left_frame, text="Branch", font=labelfont, bg=lf_bg).place(relx=0.3, rely=0.7)
